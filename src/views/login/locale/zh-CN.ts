export default {
  ...
  'login.form.mobile.errMsg': '手机号码不能为空',
  ...
  'login.form.mobile.placeholder': '手机码号',
  'login.form.password.placeholder': '密码',
  'login.form.rememberPassword': '记住密码',
  'login.form.forgetPassword': '忘记密码',
  'login.form.login': '登录',
  'login.form.code.placeholder': '短信验证码',
  'login.form.register': '注册账号',
  'login.form.account': '账号',
  'login.form.account.mobile': '账号(手机号码)',
  'login.form.invitecode': '验证码',
