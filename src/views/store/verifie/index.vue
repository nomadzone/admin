<template>
    <div class="common-page-container store-verifie-page">
        <div class="common-panel">
            ...
            <div class="page-body">
                <div class="verifie-index" v-if="verifieType === null && examineStatus === 0">
                ...
                <div v-if="examineStatus === 0">
                    <Company v-if="verifieType ===1" />
                    <Person v-else-if="verifieType === 0" />
                </div>
                <VerifieStatus v-else :info="approveInfo"  />
...
const approveInfo = ref(null)   // 认证信息
// 获取店铺认证状态
