                ...
                <a-row>
                    <a-col :xs="{ span: 24 }" :sm="{ span: 24 }" :md="{ span: 24 }" :lg="{ span: 16, offset: 4 }"
                        ...
                        <a-form ref="shopSaveFormRef" :model="form" :label-col-props="{ span: 5 }"
                            ...
                            <a-form-item :label="t('store.setting.contactInformation')" field="qrCode">
                                <PicUpload :limit="1" @updateFileList="handleSetContactInformation" :fileList="[form.qrCode]"/>
                            </a-form-item>
                            ...
                            <a-form-item :label="t('store.setting.imgs')">
                                <PicUpload :limit="9" @updateFileList="handleSetShowImages" :fileList="form.profilePhotoUrl"/>
                            </a-form-item>
...
import { addShop, getShopAddressPoint } from '@/api/shop'
...
const rules = {
    ...
    qrCode: [
        { required: true, message: t('store.setting.contactInformationPlaceholder'), trigger: 'change' }
    ],
    shopStatus: [
...
const getShop = async () => {
    ...
    if (res.data) {
        ...
        let contractImgs = [{url: res.data.qrCode}]
